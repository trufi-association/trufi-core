...
import 'package:trufi_core/repositories/services/gps_lcoation/alerts_location_denied.dart';
...
class GPSLocationProvider {
    ...
    _positionSub = Geolocator.getPositionStream(locationSettings: settings)
        .listen(
          ...
          onError: (err) async {
            _location$.add(null);
            if (context != null) {
              await _handleError(err as Object, context);
            }
          },
          cancelOnError: false,
        );
  ...
  Future<void> _handleError(Object err, BuildContext context) async {
    final msg = switch (err) {
      LocationServiceDisabledException _ => 'Location services are disabled.',
      PermissionDeniedException _ => 'Location permission was denied.',
