    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: const Text('actionBuyTicket'),
        ),
      ),
    );
  }
...
List<PopupMenuEntry<_TicketAction>> _menuFor(FareTicket t) {
  final items = <PopupMenuEntry<_TicketAction>>[
    const PopupMenuItem(value: _TicketAction.details, child: Text('Details')),
  ...
  items
    ...
    ..add(
      const PopupMenuItem(value: _TicketAction.share, child: Text('Share')),
    );
  return items;
}
  ...
  switch (a) {
    ...
    case _TicketAction.refund:
      _confirm(context, 'Are you sure you want to request a refund?', () {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('Refund requested')));
      });
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text('Select your ticket type'),
              const SizedBox(height: 16),
              Row(
                children: [
                  Expanded(
                    child: FilledButton.icon(
                      ...
                      label: const Text('Buy Single Ride'),
                    ),
                  ),
