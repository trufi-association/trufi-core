...
class VehiclePlaces {
  ...
  factory VehiclePlaces.fromMap(Map<String, dynamic> json) => VehiclePlaces(
    ...
    wheelchairAccessibleCarSpaces: int.tryParse(
      json['wheelchairAccessibleCarSpaces'].toString(),
    ),
  );
  ...
  VehiclePlacesEntity toVehiclePlacesEntity() {
    return VehiclePlacesEntity(
      bicycleSpaces: bicycleSpaces,
      carSpaces: carSpaces,
      wheelchairAccessibleCarSpaces: wheelchairAccessibleCarSpaces,
    );
