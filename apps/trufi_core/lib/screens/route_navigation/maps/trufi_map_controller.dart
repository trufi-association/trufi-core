...
class TrufiLocation {
  ...
  String displayName(TrufiLocalizations localization) {
    ...
    if (type == TrufiLocationType.selectedOnMap && description.isEmpty) {
      return localization.selectedOnMap;
    }
    ...
    if (description.isNotEmpty) {
      ...
      if (detected != null) {
        final base = detected.getLocalizedName(localization);
        return isLatLngDefined ? base : localization.defaultLocationAdd(base);
      }
      return [
        description,
