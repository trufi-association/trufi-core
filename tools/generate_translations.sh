...
flutter gen-l10n --arb-dir = translations --template-arb-file=trufiapp_en_US.arb --output-localization-file=trufi_localization.dart --output-class = TrufiLocalization --output-dir = lib\l10n --no-synthetic-package
