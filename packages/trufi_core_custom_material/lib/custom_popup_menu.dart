...
class TrufiPopupMenuButton<T> extends StatefulWidget {
  /// Creates a button that shows a popup menu.
  ///
  /// The [itemBuilder] argument must not be null.
  const TrufiPopupMenuButton({
    super.key,
  ...
  @override
  TrufiPopupMenuButtonState<T> createState() => TrufiPopupMenuButtonState<T>();
}

/// The [State] for a [TrufiPopupMenuButton].
///
/// See [showButtonMenu] for a way to programmatically open the popup menu
/// of your button state.
class TrufiPopupMenuButtonState<T> extends State<TrufiPopupMenuButton<T>> {
  /// A method to show a popup menu with the items supplied to
  /// [TrufiPopupMenuButton.itemBuilder] at the position of your [TrufiPopupMenuButton].
  ///
  /// By default, it is called when the user taps the button and [TrufiPopupMenuButton.enabled]
  /// is set to `true`. Moreover, you can open the button by calling the method manually.
  ///
  /// You would access your [TrufiPopupMenuButtonState] using a [GlobalKey] and
