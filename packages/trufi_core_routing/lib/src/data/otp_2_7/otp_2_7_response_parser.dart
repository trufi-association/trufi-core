...
/// Parses OTP 2.7 standard GraphQL responses into domain entities.
///
/// OTP 2.7 is similar to 2.8 but without emissions data.
class Otp27ResponseParser {
  Otp27ResponseParser._();

  /// Parses a plan response from OTP 2.7.
  ...
  static Itinerary _parseItinerary(Map<String, dynamic> json) {
    ...
    // OTP 2.7 returns times in milliseconds since epoch
    ...
    return Itinerary(
      ...
      // OTP 2.7 does not have emissions data
