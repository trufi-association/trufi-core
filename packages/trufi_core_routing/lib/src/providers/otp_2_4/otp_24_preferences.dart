...
/// Internal preferences state for OTP 2.4 provider.
///
/// Handles its own persistence with SharedPreferences.
class Otp24PreferencesState extends ChangeNotifier {
  static const _key = 'routing_prefs_otp24';
...
/// Complete preferences UI for OTP 2.4 provider.
class Otp24Preferences extends StatelessWidget {
  final Otp24PreferencesState state;

  const Otp24Preferences({super.key, required this.state});
