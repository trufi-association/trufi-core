...
abstract class TransportListLocalizations {
  TransportListLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static TransportListLocalizations? of(BuildContext context) {
    return Localizations.of<TransportListLocalizations>(context, TransportListLocalizations);
  }

  static const LocalizationsDelegate<TransportListLocalizations> delegate = _TransportListLocalizationsDelegate();
...
class _TransportListLocalizationsDelegate extends LocalizationsDelegate<TransportListLocalizations> {
  const _TransportListLocalizationsDelegate();

  @override
  Future<TransportListLocalizations> load(Locale locale) {
    return SynchronousFuture<TransportListLocalizations>(lookupTransportListLocalizations(locale));
  }
...
TransportListLocalizations lookupTransportListLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'de': return TransportListLocalizationsDe();
    case 'en': return TransportListLocalizationsEn();
    case 'es': return TransportListLocalizationsEs();
  }
