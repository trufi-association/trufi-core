...
class POILayersLocalizationsDe extends POILayersLocalizations {
  POILayersLocalizationsDe([String locale = 'de']) : super(locale);
  ...
  @override
  String get setAsOrigin => 'Von hier';
  ...
  @override
  String get selectPlace => 'Ort auswählen';
  ...
  @override
  String get subcategoryTypes => 'Typen';

  @override
  String get selectAll => 'Alle';

  @override
  String get clearAll => 'Löschen';

  @override
  String typesAvailable(int count) {
    return '$count Typen verfügbar';
  }
