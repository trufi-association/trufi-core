...
class TrufiLocalizationDe extends TrufiLocalization {
  ...
  @override
  String get tagline => 'Öffentliche Verkehrsmittel in Cochabamba';

  @override
  String get description => 'Der beste Weg mit Trufis, Mikros und Bussen durch Cochabamba zu reisen.';
  ...
  @override
  String get errorNoTransitTimes => 'Keine Abfahrtszeiten verfügbar. Das Datum liegt eventuell zuweit in der Vergangenheit oder der Zukunft oder es gibt keinen Transitservice zu dem von Ihnen gewählten Zeitpunkt.';
  ...
  String shareAppText(Object url) {
    return 'Hol\' dir die Trufi, die App für den öffentlichen Nahverkehr in Cochabamba, auf ${url}';
  }
  ...
  @override
  String get teamContent => 'Wir sind ein internationales Team mit dem Namen Trufi Association, das diese App mit Hilfe vieler Freiwilliger erstellt hat! Möchtest du mithelfen, die Trufi App zu verbessern und Teil unseres Teams sein? Bitte kontaktiere uns über:';
  ...
  @override
  String get appReviewDialogContent => 'Unterstüzte uns mit einer Bewertung im Google Play Store.';
...
class TrufiLocalizationDeDe extends TrufiLocalizationDe {
  TrufiLocalizationDeDe(): super('de_DE');
