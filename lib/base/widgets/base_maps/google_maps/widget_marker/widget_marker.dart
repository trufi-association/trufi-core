...
class WidgetMarker {
  ...
  /// WidgetBuilder for use widgets how markers.
  final Widget widget;
  ...
  Object toJson() {
    ...
    addIfPresent('infoWindow', _toJson(infoWindow.title, infoWindow.snippet));
  ...
  Object _toJson(String? title, String? snippet) {
    final Map<String, Object> json = <String, Object>{};
  ...
  bool operator ==(Object other) {
    ...
    if (other is! WidgetMarker) return false;
    final WidgetMarker typedOther = other;
