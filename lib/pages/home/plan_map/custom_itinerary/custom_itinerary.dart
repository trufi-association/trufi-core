...
class _CustomItineraryState extends State<CustomItinerary> {
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: OutlinedButton(
                                        onPressed: () async {
                                          await _fetchMoreitineraries(true);
                                        },
                                        child: Text(
                                          // TODO translate Später
                                          'Later departures',
                                          style: TextStyle(
                                    ...
                                    Expanded(
                                      child: OutlinedButton(
                                        onPressed: () async {
                                          await _fetchMoreitineraries(false);
                                        },
                                        child: Text(
                                          // TODO translate Früher
                                          'Earlier departures',
                                          style: TextStyle(
                                              color: Theme.of(context)
                                                  .primaryColor),
                                        ...
                                        Container(
                                          ...
                                          height: 50 *
                                              MediaQuery.of(context)
                                                  .textScaleFactor,
                                          color:
                                              currentPlanItinerary == itinerary
                                                  ? theme.primaryColor
                                                  : Colors.grey[200],
                                          margin:
  ...
  Future<void> _fetchMoreitineraries(bool isFetchEarlier) async {
